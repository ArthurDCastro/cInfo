...
*/
    ...
    class Controller extends Construct
    {
        ...
        public function index(){
            ...
            $data['grafico'] = $this->grafico->crud->getGraficos_byCodigo('5b75adc19364f');
            $data['grafico2'] = $this->grafico->crud->getGraficos_byCodigo('5b75b106d51f7');
            $data['grafico3'] = $this->grafico->crud->getGraficos_byCodigo('5b762251e1c70');
